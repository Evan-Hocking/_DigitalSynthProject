export function init() {
    const data = {
        name: "Highpass",
        file: "highpass.mjs",
        description: "Passes frequencies above a certain cutoff frequency while attenuating frequencies below it."
    }
    return data;
}
...
export function buildui(filterID, sampleRate, removeParentDiv,updateFilterParams) {
    return new Promise((resolve, reject) => {
        ...
        desc.textContent = 'Blocks low frequencies'
        ...
        freqcontainer.title = "Specifies the cutoff frequency of the highpass filter. Frequencies above this value are passed, while those below are attenuated."
        ...
        qcontainer.title = "Determines the sharpness of the filter's transition between passed and attenuated frequencies."
