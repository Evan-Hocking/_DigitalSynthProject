export function init() {
    const data = {
        name: "lowshelf",
        file: "lowshelf.mjs",
        description: "Boosts or attenuates frequencies below a specified cutoff frequency."
    }
    return data;
}
...
export function buildui(filterID, sampleRate, removeParentDiv,updateFilterParams) {
    return new Promise((resolve, reject) => {
        ...
        desc.textContent = 'Boosts low frequencies'
        ...
        freqcontainer.title = "Specifies the frequency at which the lowshelf filter starts to affect the signal."
